...
def weighted_loss(y_true, y_pred):
    ...
    weight = K.exp(-0.05 * K.abs(y_true))  
...
# Modeli kaydet
model.save("C:/Users/atade/Desktop/test_sonuçları/VGG16+TEST/model/VGG16_feature_extracted_model_Yeni5100_turevliepoch40.keras")
