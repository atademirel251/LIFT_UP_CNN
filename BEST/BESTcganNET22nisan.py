...
# Training function
def train_gan(gan, generator, discriminator, images, frequencies, latent_dim, epochs=20000, batch_size=16, save_interval=500):
...
generator.save("generator_model20_nisan.h5")