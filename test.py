...
# Veri Hazırlığı Fonksiyonunu Tekrar Tanımla
...
# **Test verisini tekrar yükle**
image_folder = "C:/Users/atade/Desktop/1000verısetı/input_Resşm"
csv_folder = "C:/Users/atade/Desktop/1000verısetı/csv"

# **Tüm veriyi yükle**
X_data, y_data = load_data_in_order(image_folder, csv_folder, max_length=102)

# **Test setini tekrar oluştur**
from sklearn.model_selection import train_test_split
_, X_test, _, y_test = train_test_split(X_data, y_data, test_size=0.2, random_state=42)

# **Modeli yükle**
model_path = r"C:\Users\atade\Desktop\test_sonuçları\VGG16+TEST\model\VGG16_feature_extracted_model.keras"
loaded_model = tf.keras.models.load_model(model_path)
print(f"Model başarıyla yüklendi: {model_path}")

# **Test verisiyle tahmin yap**
example_index = 56 # Örnek test verisi seç
